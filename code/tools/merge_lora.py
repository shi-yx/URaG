...
def merge_URaG(model_path, model_base, save_path):
    processor = AutoProcessor.from_pretrained(model_base, max_pixels=1024*28*28)
...
if __name__ == "__main__":
    ...
    merge_URaG(args.model_path, args.model_base, args.save_path)