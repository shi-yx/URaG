...
class SupervisedDataset(Dataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        retrieval_labels = torch.tensor(sources["retrieval_labels"])
...
class DataCollatorForSupervisedDataset(object):
    ...
    def __call__(self, examples):
        ...
        for example in examples:
            ...
            batch_retrieval_labels.append(example["retrieval_labels"])
        ...
        retrieval_labels = pad_sequence(batch_retrieval_labels, padding_side='right', padding_value=IGNORE_INDEX)
        data_dict = {
            'input_ids': input_ids,
            'retrieval_labels': retrieval_labels,
            'attention_mask': attention_mask,
